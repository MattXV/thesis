...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
       \centering
       \includegraphics[width=\textwidth]{bvh1}\label{fig:sub_bvh1}
       \caption{Triangulated Mesh}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\textwidth}
       \centering
       \includegraphics[width=\textwidth]{bvh2}\label{fig:sub_bvh2}
       \caption{Bounding Volumes}
    \end{subfigure}

    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{bvh3}\label{fig:sub_bvh3}
        \caption{Tree}
    \end{subfigure}
