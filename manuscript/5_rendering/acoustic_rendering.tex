...
As illustrated in Chapter~\ref{ch:litReview}, deep learning-based approaches have not seen as much progress as tree structures due to their recent nature; \acrshortpl{bvh} have become fast and feasible for interactive applications \citep{kopta2012fast}.\par
