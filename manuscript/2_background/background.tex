...
\subsection{Application to Virtual Enviroments}
Deep learning techniques are becoming increasingly popular in virtual environment pipelines due to the flexibility and potential of adapting to a variety of tasks. 
\begin{itemize}
