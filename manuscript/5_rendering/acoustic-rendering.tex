...
The prototype acoustic render considers constant air absorption due to the deployment of the prototype in an environment with constant temperature and humidity, as shown in Chapter~\ref{ch:evaluation}. Air absorption is  
...
\begin{table}[]
    ...
    40       & 0.00   & 0.001 & 0.005 & 0.0013          & 0.0037 & 0.0242 \\
    50       & 0.00   & 0.001 & 0.004 & 0.0013          & 0.0027 & 0.0207 \\
    60       & 0.0003 & 0.003 & 0.005 & 0.0013          & 0.0027 & 0.0169 \\
    70       & 0.0004 & 0.004 & 0.005 & 0.0013          & 0.0027 & 0.014 
    \end{tabular}
    \caption{Acoustic }
    \label{tab:my-table}
    \end{table}

\citep{nikolic2002improvements,harris1966absorption}
...
\begin{figure}[htbp]
    ...
    \caption{Time and frequency-domain representations left and right subfigures, respectively, of frequency-dependent \acrshortpl{rir} combined into a broadband monoaural response. }
