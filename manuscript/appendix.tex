...
The proof of concept is demonstrated in three real spaces: a small, a medium, and a large environment, see Table~\ref{tab:material-eval-scenes}. These environments have diverse ecosystems of surfaces and materials that characterise and determine their respective soundscape and acoustic fingerprints. Figures~\ref{fig:mastering-suite-superpixels},~\ref{fig:recital-hall-superpixels}, and~\ref{fig:guild-hall-superpixels} show demonstrations of superpixel-based material tagging on textures extracted from the three spaces.
\input{scenes} %tab:material-eval-scene


\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{guildhall}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{recital-hall}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{mastering_suite}
