...
Detecting the presence of certain objects in an image represents a milestone in the development of \acrshortpl{cnn} and computer vision techniques as it emulates a basic task of the human visual system \cite{szeliski2022computer}.

labelled datasets \cite{deng2009imagenet}

evolution of convolutional layers \cite{Redmon_2016_CVPR}
