...
A user interface system presents stimuli to participants.

Proxemics involves using physical distance as a dimension of interaction design, where the spatial relationship between users and devices influences interaction possibilities 
Non-diegetic UIs are often more straightforward to implement and can provide clear, immediate access to information and controls. They are commonly used for displaying data relating to the complex scene or the task being performed.

\citep{dickinson2021diegetic}

Studies have shown that diegetic interfaces can provide high-quality interactions and maintain a user's sense of presence, although they may sometimes increase perceived workload
